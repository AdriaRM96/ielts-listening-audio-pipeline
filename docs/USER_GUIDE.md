...
This guide walks through setup for anyone using this tool without a coding background — every step is copy-paste, and no prior Google Cloud or command-line experience is assumed. If you're a developer or ML reviewer, the [README](../README.md) has a faster path.
